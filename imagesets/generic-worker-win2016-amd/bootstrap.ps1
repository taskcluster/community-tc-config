...
Expand-Archive $LocalFilePath -DestinationPath C:\AMD -Verbose
$Driverdir = Get-ChildItem C:\AMD -Directory -Filter "*Retail_End_User*" | %{$_.FullName}
