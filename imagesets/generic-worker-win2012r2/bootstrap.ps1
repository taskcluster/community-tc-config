...
$client.DownloadFile("https://github.com/taskcluster/taskcluster/releases/download/v32.0.0/taskcluster-proxy-windows-amd64", "C:\generic-worker\taskcluster-proxy.exe")
