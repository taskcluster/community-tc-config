...
function deploy {
    ...
    case "${CLOUD}" in
        aws)
            ...
            echo us-west-1 118 246 us-west-2 199 220 us-east-1 4 200 | xargs -P3 -n3 "./$(basename "${0}")" process-region "${CLOUD}_${ACTION}"
